    ...
    <div className="relative">
      ...
      {selected ? (
        <div>
          ...
          <div
            className="mt-1 flex items-center gap-2 rounded-md border border-l-4 border-l-[var(--cds-interactive)] border-neutral-200 bg-neutral-50 px-3 py-2 text-sm"
          >
        ...
        <>
          ...
          {open && (loading || matches.length > 0) && (
            <ul className="absolute left-0 right-0 top-full z-10 mt-1 max-h-64 overflow-y-auto rounded-md border border-neutral-200 bg-white shadow-md">
              {loading && (
