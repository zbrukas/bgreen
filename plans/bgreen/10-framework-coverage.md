...
> **Status:** In progress — V10.1 + V10.2 + V10.3 shipped.
...
- **V10.4 (next):** Full UI — framework picker, coverage matrix with filters, admin mapping screen, AI explanation panels.
